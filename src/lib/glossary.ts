...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  { name: 'Cardiolipin IgG Ab', panel: 'Lupus/APS Markers', description: 'IgG antibodies against cardiolipin measured by a hematology-lab method (reported in CU units).', clinical: 'Functionally equivalent to Anticardiolipin IgG — tests for the same phospholipid target. Reported in CU (chemiluminescent units). Elevated levels are a criterion for APS. Persistent positivity at medium-to-high titer (>20 CU) on two tests 12+ weeks apart is required for APS diagnosis.' },
  { name: 'Cardiolipin IgM Ab', panel: 'Lupus/APS Markers', description: 'IgM antibodies against cardiolipin measured by a hematology-lab method (reported in CU units).', clinical: 'Equivalent to Anticardiolipin IgM. IgM positivity alone is less specific for APS than IgG but still part of the diagnostic criteria. Can be transiently positive after infection. Persistent elevation above 20 CU is significant.' },
  { name: 'Beta-2 Glycoprotein IgG Ab', panel: 'Lupus/APS Markers', description: 'IgG antibodies against beta-2 glycoprotein I measured by a hematology-lab method (reported in CU units).', clinical: 'Same target as Beta-2 Glycoprotein I IgG — the most specific antiphospholipid antibody for APS. Strong association with arterial and venous thrombosis and pregnancy complications. Persistent levels above 20 CU meet APS criteria.' },
  { name: 'Beta-2 Glycoprotein IgM Ab', panel: 'Lupus/APS Markers', description: 'IgM antibodies against beta-2 glycoprotein I measured by a hematology-lab method (reported in CU units).', clinical: 'Same target as Beta-2 Glycoprotein I IgM. Less specific than IgG but part of the APS antibody triad. Significantly elevated levels (>20 CU) persistent over 12 weeks contribute to APS diagnosis, especially when combined with other positive antibodies.' },
  ...
  { name: 'Lupus PTT Screen', panel: 'Lupus Anticoagulant (LA)', description: 'A modified partial thromboplastin time using a low-phospholipid reagent, making it more sensitive to lupus anticoagulant antibodies.', clinical: 'A prolonged result suggests LA interference. Must be followed by a mixing study and confirmatory test before LA can be confirmed. Normal range ~25–37 seconds. Part of the International Society on Thrombosis and Haemostasis (ISTH) LA testing algorithm.' },
  { name: 'ACT PTT', panel: 'Lupus Anticoagulant (LA)', description: 'Activated clotting time variant of the PTT. Another phospholipid-dependent assay used as a screening test for lupus anticoagulant.', clinical: 'Like the Lupus PTT Screen, it is prolonged when LA antibodies interfere with phospholipid-dependent coagulation. Used alongside DRVVT to improve sensitivity for LA detection. Evaluated as part of a two-reagent screening protocol.' },
  { name: 'DRVVT Screen', panel: 'Lupus Anticoagulant (LA)', description: 'Dilute Russell\'s Viper Venom Time — screening step. Uses snake venom to directly activate factor X in a low-phospholipid environment, making it highly sensitive to LA antibodies.', clinical: 'A ratio >1.20 is positive and suggests LA antibody interference. The DRVVT is the most widely used and sensitive single test for LA. An elevated screen must be confirmed with a mixing study and confirm step before LA can be reported as positive.' },
  { name: 'DRVVT Screen 1:1 Mix', panel: 'Lupus Anticoagulant (LA)', description: 'The DRVVT screening test repeated on a 1:1 mix of patient plasma with normal pooled plasma.', clinical: 'Distinguishes LA from a factor deficiency. If the prolonged clotting time corrects toward normal after mixing, a factor deficiency is likely. If it remains prolonged (does not correct), an inhibitor such as LA is present. A ratio >1.20 on the mix confirms an inhibitor pattern.' },
  { name: 'DRVVT Confirm', panel: 'Lupus Anticoagulant (LA)', description: 'Confirmatory DRVVT step using excess phospholipid to neutralize LA antibodies and shorten the clotting time.', clinical: 'LA antibodies bind to phospholipid; adding excess phospholipid overwhelms the antibodies and normalizes the result. A significant shortening of the clotting time (correction) confirms that phospholipid-binding antibodies — i.e., LA — were the cause of the prolonged screen.' },
  { name: 'DRVVT Ratio', panel: 'Lupus Anticoagulant (LA)', description: 'Screen-to-confirm ratio. Divides the DRVVT screen result by the DRVVT confirm result.', clinical: 'A ratio >1.20 is the standard ISTH threshold for LA positivity. The higher the ratio, the stronger the LA signal. This normalized ratio corrects for patient-to-patient variation in baseline clotting times and is the primary number reported as LA positive or negative.' },
